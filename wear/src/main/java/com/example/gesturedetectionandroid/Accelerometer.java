    ...
    Accelerometer(Context context) {
        ...
        sensorEventListener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                //    System.out.println(sensorEvent.timestamp+" ACC"+sensorEvent.values[0]+" "+sensorEvent.values[1]+" "+sensorEvent.values[2]);
             //       new SendThread(datapath, sensorEvent.timestamp+" ACC"+sensorEvent.values[0]+" "+sensorEvent.values[1]+" "+sensorEvent.values[2], context.getApplicationContext()).start();
